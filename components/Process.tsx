        ...
        <div className="flex flex-col md:flex-row items-center gap-20">
          ...
          <div className="md:w-1/2">
            ...
            <div className="space-y-12 relative">
              ...
              {[
                { title: "Forward Email", text: "Send customer's RFQ to your AI inbox. We handle everything from there." },
                { title: "AI Extracts & Suggests", text: "Instantly get job details parsed and pricing suggestions based on your past wins." },
                { title: "Review & Send", text: "Review the AI-drafted proposal, add your personal touch, and send it off—all in under 5 minutes." }
              ].map((step, i) => (
