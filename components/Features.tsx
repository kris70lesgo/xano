  ...
  const features = [
    {
      ...
      desc: "AI extracts scope, materials, location, timeline, and budget from RFQ emails in seconds. No more manual note-taking."
    },
    {
      icon: <TrendingUp className="w-8 h-8 text-white" />,
      title: "Smart Pricing Suggestions",
      desc: "Analyzes your past wins and market rates to suggest optimal pricing. Win more bids without leaving money on the table."
    },
    {
      icon: <DollarSign className="w-8 h-8 text-white" />,
      title: "Professional Proposal Drafts",
      desc: "Ready-to-send proposals in under a minute. You review, add personal touches, and close deals faster."
    }
  ];
    ...
    <section id="features" className="py-32 bg-cream relative overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <Reveal delay={0.2}>
             <p className="text-xl text-gray-600 max-w-3xl mx-auto">Stop losing jobs because your proposal arrives too late. Respond in minutes, not hours.</p>
          </Reveal>
        </div>
