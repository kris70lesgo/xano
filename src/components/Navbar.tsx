...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-cream/95 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-6'
        }`}
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-2 cursor-pointer z-50 group">
          ...
          <span className="text-2xl font-bold font-serif tracking-tight text-dark">Tendr</span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-6">
          <a href="/login" className="text-base font-bold text-dark hover:text-primary transition-colors">Log in</a>
          <a href="/signup" className="bg-dark text-white text-base font-bold px-6 py-3 rounded-xl hover:bg-gray-800 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-gray-200">
            Get Started
          </a>
        </div>
