  ...
  return (
    <div className="relative pt-32 md:pt-40 pb-0 w-full overflow-hidden flex flex-col items-center min-h-screen">
      ...
      <div className="relative mb-8 z-20 animate-fade-in-up [animation-delay:500ms] group">
        ...
        <a href="/signup" className="inline-block relative bg-primary text-white font-bold text-lg px-12 py-5 rounded-2xl shadow-[0_20px_40px_-15px_rgba(255,107,107,0.5)] transition-all hover:scale-110 hover:-translate-y-2 active:scale-95 overflow-hidden">
